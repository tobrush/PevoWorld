...
namespace DA_Assets.FCU
{
    public class Localization
    {
        ...
        public const string PROJECT_NOT_FOUND = "Either this file doesn’t exist or you don’t have permission to view it. Ask the file owner to verify the link and/or update permissions.";
        ...
        public const string START_ADD_LINKS = "Start adding sprite-links";
        ...
        public const string SSL_ERROR = "{0}. Try disable HTTPS in asset settings.";
    }
}
#endif