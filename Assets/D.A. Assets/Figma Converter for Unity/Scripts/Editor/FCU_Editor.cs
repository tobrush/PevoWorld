                ...
                Body = () =>
                {
                    ...
                    gui.DrawGroup(new Group
                    {
                        ...
                        Body = () =>
                        {
                            ...
                            figmaConverterUnity.mainSettings.DevMode = gui.Toggle(new GUIContent("Dev Mode", "Feature for developers. Allows to save the received response from Figma in json format."),
                                figmaConverterUnity.mainSettings.DevMode);
