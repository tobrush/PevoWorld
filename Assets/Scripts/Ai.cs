...
public class Ai : MonoBehaviour
{
    ...
    private void Start()
    {
        playerChacater[int.Parse(UserData.instance.Dog1_Character)-2].SetActive(true);
        anim = this.transform.GetChild(int.Parse(UserData.instance.Dog1_Character)+2).GetComponent<Animator>();
