...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private void SnapToPanel()
        {
            ...
            Content.anchoredPosition = Vector2.Lerp(Content.anchoredPosition, targetPosition, (useUnscaledTime ? Time.unscaledDeltaTime : Time.fixedDeltaTime) * snapSpeed);
        ...
        private void GetVelocity()
        {
            ...
            float time = useUnscaledTime ? Time.unscaledDeltaTime : Time.fixedDeltaTime;
